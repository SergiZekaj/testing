...
public class PersonTest {
    ...
    void setup() {
        ...
        person = new TestPerson("P001", "John Doe", "1234567890", "Male");
    }
    ...
    @Test
    void testGetName() {
        assertEquals("John Doe", person.getName(), "The name should be John Doe");
    }

    @Test
    void testSetName() {
        person.setName("Jane Doe");
        assertEquals("Jane Doe", person.getName(), "The name should be updated to Jane Doe");
    }
